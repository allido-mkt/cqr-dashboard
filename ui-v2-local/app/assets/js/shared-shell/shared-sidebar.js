(() => {
  ...
  const ICONS = {
    ...
    retention: '<circle cx="8" cy="7" r="3"/><path d="M3 19v-1.2c0-3.2 2.2-5.5 5-5.5 1.4 0 2.6.4 3.5 1.2"/><path d="M19.5 13.5A5 5 0 1 1 15 12"/><path d="M19.5 10.5v3h-3"/>',
